...
if file is not None:
    ...
    fig.update_layout(title=f"{df_dec["Pozo"].values[0]}", title_font_size = 18, title_x = 0.45, title_y = 0.97, width=1400, height=600, hovermode="x unified", xaxis_title="<b>Fecha<b>", 
